...
def run_tests():
    ...
    # 1. Test Imports
    print("\n[Test 1/5] Verifying system imports...")
    try:
    ...
    print("\n[Test 2/5] Verifying sample image generation...")
    try:
    ...
    print("\n[Test 3/5] Verifying Farneback Optical Flow interpolation baseline...")
    try:
    ...
    print("\n[Test 4/5] Verifying heatmap and flow vector visualizations...")
    try:
    ...
    print("\n[Test 5/5] Verifying PSNR and SSIM computation...")
    try:
